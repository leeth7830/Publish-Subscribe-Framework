...
/**
 * Subscriber two that reads items published by publisher and writes it to an output file.
 * @author TuckFae
 *
 * @param <T>
 */
public class SubscriberTwo<T> implements Subscriber {
	...
	public SubscriberTwo(ConfigurationManager config, int number) throws IOException {
